...
<html lang="en">
    ...
    <body id="login_x">
            <section class="head1"> 
                <?php include_once('html/headfoot/header1.php'); ?>
            </section>
            ...
            <section class="form_1">    
                ...
                <center>
                    ...
                    <h3 class="font-weight-bold mb-2 mt-2"></h3>
                        ...
                        <div class="pb-4" id="log_xc">
                              <div></div>
                              <div>
                                   <a href="html/signup" class="text-primary font-weight-bold mb-4"> <span class="text-secondary">Not Registered?</span> Signup Here </a>
                              </div>
                              <div></div>
                      </div>
                    </div>
            ...
            <!--footer start here-->
            <section class="futal">
                <?php include_once('html/headfoot/footer1.php'); ?>
            </section>
            <!--end of footer-->
